...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_manage_subscribers_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='manage-subscribers'
        )
        self.assertTrue(view.__name__ == 'manage-subscribers')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in manage-subscribers'
        # )

    def test_manage_subscribers_not_matching_interface(self):
